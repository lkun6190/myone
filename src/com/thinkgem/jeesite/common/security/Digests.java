...
public class Digests {
	...
	public static String getSHA1(Object pwd) {
		Object result = new SimpleHash(SystemService.HASH_ALGORITHM, pwd, ByteSource.Util.bytes(pwd), SystemService.HASH_INTERATIONS);
