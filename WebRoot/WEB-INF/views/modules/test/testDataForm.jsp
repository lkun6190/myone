...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#selectxmmc").click(function(){

				openwindow("/kh/khXmbab/select","项目选择");
...
<body>
	...
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test/testData/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="100" class="input-xlarge "/>  <input id="selectxmmc"  type="button" class="btn btn-primary" value="选择"/>
			</div>
		</div>
		 <td>
		  </tr>
