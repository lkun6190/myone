...
<body>
	...
	<ul class="nav nav-pills">
		...
		<li role="presentation"><a href="${ctx}/stu/selfList">学生列表</a></li>
		<shiro:hasPermission name="stu:edit:view">
			<li role="presentation" class="active"><a
				href="${ctx}/stu/selfForm">学生添加</a></li>
		</shiro:hasPermission>
	</ul>

	<form:form id="inputForm" modelAttribute="zxsStu"
		action="${ctx}/stu/selfSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<form:hidden path="zxsClass.id" />
			<div class="controls">
				<input type="text" value="${zxsStu.office.name}" htmlEscape="false"
					maxlength="50" class="required" readonly="readonly" /> <span
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" value="${zxsStu.zxsClass.classNo}"
					htmlEscape="false" maxlength="50" class="required"
					readonly="readonly" /> <span class="help-inline"><font
					color="red">*</font> </span>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="gold" htmlEscape="false" maxlength="7" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="parentName" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">家长电话:</label>
			<div class="controls">
				<form:input path="parentTel" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">与家长关系:</label>
			<div class="controls">
				<form:input path="rex" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="appPlayInfo.lessonsHis" htmlEscape="false"
					rows="7" style="width:500px;" disabled="true" maxlength="755"
					class="input-xlarge" />
