								...
								.validate(
										{
											rules : {
												stuNo : {
													remote : "${ctx}/stu/checkStuNo?oldStuNo="
															+ encodeURIComponent('${zxsStu.stuNo}')
												},
												newPassword : {
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/stu/list">学生列表</a>
		</li>
		<li class="active"><a href="${ctx}/stu/form?id=${zxsStu.id}">学生<shiro:hasPermission
					name="stu:edit:view">${not empty zxsStu.id?'修改':'添加'}</shiro:hasPermission>
				<shiro:lacksPermission name="stu:edit:view">查看</shiro:lacksPermission>
		</a>
		</li>
	</ul>
	<br />

	<form:form id="inputForm" modelAttribute="zxsStu"
		action="${ctx}/stu/save" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:class_treeselect id="office" name="office.id"
					value="${zxsStu.office.id}" labelName="office.name"
					labelValue="${zxsStu.office.name}" title="所属代理或机构"
					url="/sys/office/treeData?type=2" cssClass="required"
					notAllowSelectRoot="${root_tmp }" notAllowSelectParent="true" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="zxsClass" name="zxsClass.id"
					value="${zxsStu.zxsClass.id}" labelName="zxsClass.classNo"
					labelValue="${zxsStu.zxsClass.classNo}" title="所属班级"
					url="/cla/findCla" cssClass="required" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="no" htmlEscape="false" maxlength="30" class="no" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="stuName" htmlEscape="false" maxlength="50"
					class="required" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input id="oldStuNo" name="oldStuNo" type="hidden"
					value="${zxsStu.stuNo}">
				<form:input path="stuNo" htmlEscape="false" maxlength="50"
					class="required StuNo" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="newPassword" name="newPassword" type="password"
					...
					class="${empty zxsStu.id?'required':''}" /> <font color="red">4-16个字符，不能包含空格！</font>
				<c:if test="${empty zxsStu.id}">
					<span class="help-inline"><font color="red">*</font> </span>
				</c:if>
				<c:if test="${not empty zxsStu.id}">
		...
		<%--<div class="control-group">
			...
			<div class="controls">
				<form:input path="gold" htmlEscape="false" maxlength="10" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="age" htmlEscape="false" maxlength="3" id="ageInput" disabled="true"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="birth" name="birth" type="text" maxlength="20"
					...
					value="<fmt:formatDate value="${zxsStu.birth}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="birth" name="entryDate" type="text" maxlength="20"
					class="input-mini Wdate"
					value="<fmt:formatDate value="${zxsStu.entryDate}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="parentName" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">家长电话:</label>
			<div class="controls">
				<form:input path="parentTel" htmlEscape="false" maxlength="25" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">与家长关系:</label>
			<div class="controls">
				<form:input path="rex" htmlEscape="false" maxlength="20" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="birth" name="payDate" type="text" maxlength="20"
					class="input-mini Wdate"
					value="<fmt:formatDate value="${zxsStu.payDate}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="appPlayInfo.lessonsHis" htmlEscape="false"
					rows="7" style="width:600px;" disabled="true" maxlength="755"
					class="input-xlarge" />
			</div>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="lbl"><fmt:formatDate
							value="${zxsStu.createDate}" type="both" dateStyle="full" /> </label>
				</div>
			</div>
