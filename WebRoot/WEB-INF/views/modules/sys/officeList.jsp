	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="sys:office:edit"><td>
				...
				<a href="${ctx}/sys/office/delete?id={{row.id}}" onclick="return confirmx('要删除该机构及所有子机构项和机构的班级老师学生成功吗？', this.href)">删除</a>
				
<a href="${ctx}/sys/office/form?parent.id={{row.id}}&grade={{row.grade}}">
{{row.tip_tmp}}
</a> 
