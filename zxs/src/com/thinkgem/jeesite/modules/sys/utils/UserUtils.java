	...
	public static List<Office> getOfficeList(){
		...
		if (officeList == null){
			...
			if (user.isAdmin()){
				...
				office.setParentIds(UserUtils.getUser().getOffice().getParentIds()+UserUtils.getUser().getOffice().getId()+","+"%");
...
//	}
	...
	public static User getAPPUser(HttpServletRequest request){
		Object obj =request.getSession().getAttribute("USER");
		if(obj == null){
			obj = getUser();
		}
