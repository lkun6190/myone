...
public class GenUtils {
	...
	public static String getTemplatePath(){
		...
		String path = StringUtils.getProjectPath() + StringUtils.replaceEach(".src." + GenUtils.class.getName(), 
...
//			logger.debug("read config content: {}", content);
	...
	public static <T> T fileToObject(String fileName, Class<?> clazz){
		...
		if(pathroot.indexOf("GenUtils.class") >0 ){
			pathroot = pathroot.replace("\\util\\GenUtils.class", "\\template\\");
		}else{
			pathroot += "\\com\\thinkgem\\jeesite\\modules\\gen\\template\\";
		}
