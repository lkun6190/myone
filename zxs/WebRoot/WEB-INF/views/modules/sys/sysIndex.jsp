...
.navbar .nav>li.dropdown>a:focus,.navbar .nav>li.dropdown>a:hover {
	background: 0 none;
}

.navbar-inner {
	border: 1px solid #cad0b9;
	/* background-image: url(${ctxStatic}/images/top.png) !important; */
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				 <div class="brand" style="padding: 14px 40px 7px;">
					<span id="productName">
							珠心算教务管理系统
							</span>
				</div> 
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/yj/sysYj/list" target="mainFrame"><i
									class="icon-lock"></i>&nbsp; 常用意见</a></li> --%>
						</ul></li>
					<li><a href="${ctx}/logout" id="logout" title="退出登录">退出</a></li>
					...
					<ul id="menu" class="nav"
						...
						<c:forEach items="${fns:getMenuList()}" var="menu"
							...
							<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
								<li
									style="width:8%;text-align:center;background:url(${ctxStatic}/images/line.png) no-repeat;background-position:left center;"
									class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}">
									<c:if test="${empty menu.href}">
										<a class="menu"
											style="padding:0;padding:5px 10px;font-family: '微软雅黑';"
											href="javascript:"
						...
						<li
							style="width:1%;text-align:center;background:url(${ctxStatic}/images/line.png) no-repeat;background-position:left center;"><a
							style="padding:0;padding:5px 10px;">&nbsp</a></li>
					</ul>
				</div>
				<!--/.nav-collapse -->
			</div>
