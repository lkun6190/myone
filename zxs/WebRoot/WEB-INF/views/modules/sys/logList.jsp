...
<body>
	...
	<!-- 	</ul> -->
	<form:form id="searchForm" action="${ctx}/sys/log/list" method="post"
		...
		<div>
			...
			<label>操作菜单：</label><input id="title" name="title" type="text"
				maxlength="50" class="input-mini" value="${log.title}" /> <label>用户登录名：</label><input
				id="createBy.loginName" name="createBy.loginName" type="text"
				maxlength="50" class="input-mini" value="${log.createBy.loginName}" />
