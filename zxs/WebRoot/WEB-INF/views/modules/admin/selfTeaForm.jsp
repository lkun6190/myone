...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/cla/list">班级列表</a>
		</li>
		<li class="active"><a href="${ctx}/tea/selfList">老师列表</a>
		</li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="zxsTea"
		action="${ctx}/tea/selfSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" value="${zxsTea.office.name}" htmlEscape="false"
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="lbl"><fmt:formatDate
							value="${zxsTea.createDate}" type="both" dateStyle="full" />
					</label>
				</div>
			</div>
