	...
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $("#btnEdit").click(function () {
                ...
                window.location = "${ctx}/test/testData/form?id=" +  chk_value[0];
            ...
            $("#btnDel").click(function () {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "${ctx}/test/testData/batchdelete",
                        type:"get",
                        ...
                        success:function(data){
                            ...
                            location = "${ctx}/test/testData/?repage";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testData/">主务主表列表</a></li>
		<shiro:hasPermission name="test:testData:edit"><li><a href="${ctx}/test/testData/form">主务主表添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/test/testData/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
            ...
            <li class="btns" > <a href="${ctx}/test/testData/form"><input  class="btn btn-primary" type="button" value="新增"/> </a>  </li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				<td><input type="checkbox" name="ids" value="${testData.id}"/> </td>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
					...
					<a href="${ctx}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该主务主表吗？', this.href)">删除</a>
